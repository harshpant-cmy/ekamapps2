    ...
    <section ref={sectionRef} id="about" className="py-20 bg-white relative overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          {/* Aditya Gupta - CPO */}
          <Card className={`border border-gray-100 shadow-lg rounded-2xl overflow-hidden transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="h-1 bg-gradient-to-r from-ekam-primary via-ekam-primary/70 to-ekam-primary"></div>
            <CardContent className="p-8 lg:p-10">
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                {/* Profile Image */}
                ...
                {/* Info */}
                <div className="flex-1 text-center lg:text-left">
                  <h3 className="text-2xl font-bold text-gray-900 mb-3">Aditya Gupta</h3>
                  <p className="text-gray-600 leading-relaxed mb-5">
                    Product leader with <span className="font-semibold text-ekam-primary">10+ years</span> of experience
                    in the Financial Industry. Deep expertise in product strategy, fintech operations, and customer-centric design.
                  </p>
