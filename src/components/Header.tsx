      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <img src="/lovable-uploads/dfb03ea5-aa2e-4225-b2ee-5646200da187.png" alt="Ekam Logo" className="h-30 w-auto object-fill" />
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Button className="bg-ekam-primary hover:bg-ekam-primary/90 text-white">Free Consultation</Button>
          </nav>

          {/* Mobile menu button */}
          <button onClick={toggleMenu} className="md:hidden p-2 rounded-md text-gray-700 hover:text-ekam-primary">
