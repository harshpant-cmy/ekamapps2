      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="/agent/lead-enrichment" className="hover:text-ekam-secondary transition-colors">Lead Enrichment</a></li>
              <li><a href="/agent/content-automation" className="hover:text-ekam-secondary transition-colors">Content Automation</a></li>
              <li><a href="/agent/customer-support" className="hover:text-ekam-secondary transition-colors">Customer Support</a></li>
              <li><a href="/agent/sales-multichannel" className="hover:text-ekam-secondary transition-colors">Sales Automation</a></li>
            </ul>
          </div>
